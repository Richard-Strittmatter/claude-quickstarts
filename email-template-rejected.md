# Email Template: Terminanfrage abgelehnt (Rejected) - Modern Design
...
<head>
  ...
  <title>Terminanfrage abgelehnt – InkBro</title>
...
<body style="margin:0; padding:0; background: linear-gradient(135deg, #f5f7fa 0%, #e8ecf1 100%);">
  ...
  <div style="display:none; font-size:1px; color:#f5f7fa; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden;">
    Terminanfrage abgelehnt: %service_name% am %appointment_date_time% bei InkBro
  </div>
            ...
            <tbody>
                      ...
                      <tr>
                        <td style="padding:0 32px 32px 32px;">
                          <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                            <tbody>
                              <tr>
                                <td style="background: rgba(251, 146, 60, 0.15); border-left: 4px solid #fb923c; padding:12px 20px; border-radius:6px;">
                                  <span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size:14px; color:#fb923c; font-weight:600; letter-spacing:0.5px;">
                                    NICHT VERFÜGBAR
                                  </span>
                                </td>
                              </tr>
              ...
              <tr>
                <td style="padding:40px 32px 32px 32px;">
                  ...
                  <p style="margin:0 0 12px 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size:16px; line-height:1.7; color:#4a5568;">
                    Leider können wir deine Terminanfrage für den gewünschten Zeitpunkt nicht bestätigen. Der angefragte Termin ist nicht verfügbar.
                  </p>
                  <p style="margin:0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size:16px; line-height:1.7; color:#4a5568;">
                    Aber keine Sorge – gerne helfen wir dir, einen alternativen Termin zu finden!
                  </p>
                </td>
              </tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size:18px; color:#888; font-weight:700;">
              ...
              <tr>
                <td style="padding:0 32px 32px 32px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#f0fdf4; border-left:4px solid #22c55e; border-radius:8px;">
                    <tbody>
                      <tr>
                        <td style="padding:20px 24px;">
                          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size:14px; color:#15803d; font-weight:600; margin-bottom:6px;">
                            Alternative Termine finden
                          </div>
                          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size:14px; color:#166534; line-height:1.6;">
                            Kontaktiere uns gerne direkt – wir besprechen gemeinsam alternative Termine und finden die perfekte Zeit für deinen Besuch bei uns.
                          </div>
                        </td>
                      </tr>
                    </tbody>
